                        ...
                        <tbody>
                            <tr v-for="(value, key) in danhSachKhoDangNhap">
                                ...
                                <td class="align-middle" style="width: 50px">
                                    <input type="number" min="1" class="form-control text-center" v-bind:value="value.so_luong">
                                </td>
                                <td class="align-middle">
                                    <input type="number" class="form-control text-center" v-bind:value="value.don_gia">
                                </td>
                                <td class="align-middle">
